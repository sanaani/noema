...
| 09-21 | `a142bcc` | Proof size — the confound that faked AUC 0.740 on the replication target — is a coin flip on the 2026 label at 0.515, against the angle's 0.958. |
